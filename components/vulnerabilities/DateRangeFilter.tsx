...
interface DateRangeFilterProps {
  ...
  dateField: 'last_update' | 'publication_date'
  onDateFieldChange: (field: 'last_update' | 'publication_date') => void
}
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={() => onDateFieldChange('publication_date')}
            className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all ${
            ...
            <div className="absolute z-50 mt-2 p-4 bg-slate-800 border border-slate-700 rounded-xl shadow-xl">
              ...
              <DayPicker
                ...
                classNames={{
                  ...
                  day_range_middle: 'bg-cyan-500/20 text-cyan-300 rounded-none',
                  day_range_start: 'bg-cyan-500 text-white rounded-l-md rounded-r-none',
                  day_range_end: 'bg-cyan-500 text-white rounded-r-md rounded-l-none',
              ...
              {hasSelection && (
                <div className="mt-4 pt-4 border-t border-slate-700 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-4 py-1.5 text-sm font-medium rounded-md bg-cyan-500 text-white hover:bg-cyan-600 transition-colors"
                  >
                    Apply
                  </button>
                </div>
